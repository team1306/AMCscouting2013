...
\noindent\begin{minipage}[t]{.2\linewidth} % Intended to prevent impossible climbing point totals.
...
\end{minipage}
\hspace*{1em}
\begin{minipage}[t]{.2\linewidth} % Should be vertically aligned with climberpts.
